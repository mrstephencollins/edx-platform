...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_teacher'
        db.add_column('auth_userprofile', 'is_teacher',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.teacher_email'
        db.add_column('auth_userprofile', 'teacher_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.class_id'
        db.add_column('auth_userprofile', 'class_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_teacher'
        db.delete_column('auth_userprofile', 'is_teacher')

        # Deleting field 'UserProfile.teacher_email'
        db.delete_column('auth_userprofile', 'teacher_email')

        # Deleting field 'UserProfile.class_id'
        db.delete_column('auth_userprofile', 'class_id')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'class_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'teacher_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
